...
V2E = {
    ...
    "Canis lupus": "canis_lupus_familiaris",
    "Ailuropoda melanoleuca": "ailuropoda_melanoleuca",
    "Felis catus": "felis_catus",
    "Mustela putorius": "mustela_putorius_furo",
    "Myotis lucifugus": "myotis_lucifugus",
...
def main() -> None:
    ...
    flat = [(mean[i, j], species[i], species[j]) for i, j in zip(*iu, strict=False)]
    flat.sort()
    for d, a, b in flat[:3]:
